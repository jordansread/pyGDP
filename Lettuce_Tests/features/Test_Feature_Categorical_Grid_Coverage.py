...
def test_FCGC(step):
    ...
    world.test_output_file_handle = test_pyGDP.submitFeatureCategoricalGridCoverage(world.shapefile, world.dataSetURI, world.dataType, world.attribute, world.value, verbose=False, outputfname='testFCGC_testfile_test')
