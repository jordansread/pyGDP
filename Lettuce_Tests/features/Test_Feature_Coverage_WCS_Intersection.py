...
def test_submit_WCS_Intersection(step):
    ...
    world.output_file = test_pyGDP.submitFeatureCoverageWCSIntersection(world.shapefile, world.dataSetURI, world.dataType, world.attribute, world.value, verbose=True, outputfname='testWCS_testfile_test')
